...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_string__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__string__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__validationMessage__ = __webpack_require__(47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__constants__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_config_checker__ = __webpack_require__(74);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_url__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ui_payment_error__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ui_payment_complete__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ui_payment_awaiting__ = __webpack_require__(50);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_coinmarketcap_client__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__assets_css_style_css__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__fonts__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__template__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__events__ = __webpack_require__(46);
...
function create(options) {
	...
	targetElem.appendChild(Object(__WEBPACK_IMPORTED_MODULE_3__utils_dom__["a" /* createElementFromHTML */])('div', Object(__WEBPACK_IMPORTED_MODULE_6__template__["a" /* mainTemplate */])()));

	var root = targetElem.querySelector(__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].root.selector);
	var header = targetElem.querySelector(__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].header.selector);
	var formPanel = targetElem.querySelector(__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].formPanel.selector);
	var goBackLink = targetElem.querySelector(__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].goBackLink.selector);
	var total = targetElem.querySelector(__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].total.selector);
	var amount = targetElem.querySelector(__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].amount.selector);
	var publicKey = targetElem.querySelector(__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].publicKey.selector);
	var submitButton = targetElem.querySelector(__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].submitButton.selector);
	
	__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].root.elem = root;
	__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].header.elem = header;
	__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].formPanel.elem = formPanel;
	__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].goBackLink.elem = goBackLink;
	__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].total.elem = total;
	__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].amount.elem = amount;
	__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].publicKey.elem = publicKey;
	__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].submitButton.elem = submitButton;

	__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].CMCCLIENT = new __WEBPACK_IMPORTED_MODULE_1__services_coinmarketcap_client__["a" /* CoinMarketCapClient */](__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].amount.elem, options); // todo: refactor this and the one in ./ui/events

	/* ---- */

	__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].total.elem.addEventListener('blur', __WEBPACK_IMPORTED_MODULE_7__events__["c" /* onValidateTotal */]);
	__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].total.elem.addEventListener('input', __WEBPACK_IMPORTED_MODULE_7__events__["c" /* onValidateTotal */]);

	__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].amount.elem.addEventListener('blur', __WEBPACK_IMPORTED_MODULE_7__events__["a" /* onValidateAmount */]);
	__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].amount.elem.addEventListener('input', __WEBPACK_IMPORTED_MODULE_7__events__["a" /* onValidateAmount */]);

	__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].publicKey.elem.addEventListener('blur', __WEBPACK_IMPORTED_MODULE_7__events__["b" /* onValidatePublicKey */]);
	__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].publicKey.elem.addEventListener('input', __WEBPACK_IMPORTED_MODULE_7__events__["b" /* onValidatePublicKey */]);
	...
	__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DTO.payment.from = __WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].publicKey.elem.value;
	...
	if (dtoTotal && dtoTotal.length > 0) {
		__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].total.elem.setAttribute('value', dtoTotal);
		__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].total.elem.setAttribute('disabled', 'disabled');
		var currencyLabel = __WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].total.elem.parentNode.querySelector('.currency').innerHTML = __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DTO.invoice.currency;
		hasValidTotal = true;
		__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].total.elem.dispatchEvent(new Event('input'));
	}
...
function createSubmitHandler(callBack) {
	var btn = __WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].submitButton.elem;
	if (btn) {
		...
		__WEBPACK_IMPORTED_MODULE_4__elems__["a" /* default */].submitButton.elem = btn;
	};
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__fortawesome_fontawesome_free_solid_faChevronCircleLeft__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_dom__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__elems__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_qrcode__ = __webpack_require__(51);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utils_wallet_format__ = __webpack_require__(73);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ui_elems__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__loader__ = __webpack_require__(75);
