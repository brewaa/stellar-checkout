...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__formatter__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__formatter__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_qrcode__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__utils__ = __webpack_require__(4);
...
CoinMarketCapClient.prototype.fetch = function() {
	var self = this;
	self.showProgress();
	return __WEBPACK_IMPORTED_MODULE_10__utils__["b" /* httpRequest */]('GET', self.url, { convert: self.options.currency }, '', true)
	.then(function(response) {
		var data = JSON.parse(response);
		if (data.length > 0) {
			...
			if (lumenPrice) {
				...
				var formattedPrice = __WEBPACK_IMPORTED_MODULE_10__utils__["d" /* replace */](__WEBPACK_IMPORTED_MODULE_2__formatter__["a" /* default */].format(__WEBPACK_IMPORTED_MODULE_2__formatter__["a" /* default */].FORMATS.DECIMAL7, self.priceInLumens), ',', '');
...
function create(selector, options) {
	...
	if (!targetElem) {
		console.log(__WEBPACK_IMPORTED_MODULE_10__utils__["a" /* _err */]('selector not found', __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].MESSAGE_TYPE.ERROR));
	}	
...
function createProgressHtml(dto) {
	...
	__WEBPACK_IMPORTED_MODULE_9_qrcode___default.a.toCanvas(qrCodeCanvas, dto.destinationKey, function (error) {
		if (error) {
			console.error(error);
		}
	});
...
var canPromise = __webpack_require__(35)
var QRCode = __webpack_require__(38)
var CanvasRenderer = __webpack_require__(54)
var SvgRenderer = __webpack_require__(55)
...
var AlignmentPattern = __webpack_require__(41)
var FinderPattern = __webpack_require__(42)
var MaskPattern = __webpack_require__(43)
var ECCode = __webpack_require__(10)
var ReedSolomonEncoder = __webpack_require__(44)
var Version = __webpack_require__(11)
var FormatInfo = __webpack_require__(47)
var Mode = __webpack_require__(1)
var Segments = __webpack_require__(48)
var isArray = __webpack_require__(5)
...
var Buffer = __webpack_require__(2)
var Polynomial = __webpack_require__(45)
...
var Mode = __webpack_require__(1)
var NumericData = __webpack_require__(49)
var AlphanumericData = __webpack_require__(50)
var ByteData = __webpack_require__(51)
var KanjiData = __webpack_require__(52)
var Regex = __webpack_require__(12)
var Utils = __webpack_require__(0)
var dijkstra = __webpack_require__(53)
