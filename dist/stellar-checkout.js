	...
	ui: {
		render: function(selector, opts) {
			...
			document.addEventListener('DOMContentLoaded', function() {
				...
				Object(__WEBPACK_IMPORTED_MODULE_3__utils_config_checker__["a" /* validateConfig */])(self.options)
				.then(function() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_error__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_stellarsdk_helper__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ui_buttons__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__buttons__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__loader__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__stellarsdk_helper__ = __webpack_require__(12);
...
function checkCurrency(currency) {
	return new Promise(function(resolve, reject) {
		...
		if (__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].CURRENCIES.indexOf(currency) === -1) {
			reject('currency not supported. allowed currencies: ' + __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].CURRENCIES.join(', ') + ';');
		}
		resolve(true);
	});
};
...
function checkStyleSheet(stylesheet) {
	return new Promise(function(resolve, reject) {
		...
		if (stylesheet) {
			return new __WEBPACK_IMPORTED_MODULE_1__loader__["a" /* default */].css(stylesheet);
		}
		resolve(true);
	});
};
...
function validateConfig(options) {
	return __WEBPACK_IMPORTED_MODULE_2__stellarsdk_helper__["a" /* default */].loadSdk()
