...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__templates_main_template_html__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__templates_payment_awaiting_mustache_html__ = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__templates_payment_complete_mustache_html__ = __webpack_require__(41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__templates_payment_error_mustache_html__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_string__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__string__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__buttons__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__validationMessage__ = __webpack_require__(46);
...
function validateAmount() {
	...
	if (isNaN(amt)) {
		result.errors.push(new __WEBPACK_IMPORTED_MODULE_3__validationMessage__["a" /* ValidationMessage */]('amount is not a number', __WEBPACK_IMPORTED_MODULE_2__elems__["a" /* default */].amount));
		result.result = false;
	}
	if (amt <= 0) {
		result.errors.push(new __WEBPACK_IMPORTED_MODULE_3__validationMessage__["a" /* ValidationMessage */]('amount must be greater than zero', __WEBPACK_IMPORTED_MODULE_2__elems__["a" /* default */].amount));
		result.result = false;
	}
	return result;
};
...
function validateTotal() {
	...
	if (isNaN(total)) {
		result.errors.push(new __WEBPACK_IMPORTED_MODULE_3__validationMessage__["a" /* ValidationMessage */]('total is not a number', __WEBPACK_IMPORTED_MODULE_2__elems__["a" /* default */].total));
		result.result = false;
	}
	if (total <= 0) {
		result.errors.push(new __WEBPACK_IMPORTED_MODULE_3__validationMessage__["a" /* ValidationMessage */]('total must be greater than zero', __WEBPACK_IMPORTED_MODULE_2__elems__["a" /* default */].total));
		result.result = false;
	}
	return result;
};
...
var ECLevel = __webpack_require__(10)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__constants__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_config_checker__ = __webpack_require__(72);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_stellarsdk_helper__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ui__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_url__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ui_payment_error__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ui_payment_complete__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ui_payment_awaiting__ = __webpack_require__(49);
...
function init(options) {
	...
	__WEBPACK_IMPORTED_MODULE_3__ui__["a" /* default */].createSubmitHandler(function(e) {
		...
		Object(__WEBPACK_IMPORTED_MODULE_9__ui_payment_awaiting__["a" /* createPaymentAwaitingTemplate */])(dto);
		...
		__WEBPACK_IMPORTED_MODULE_2__utils_stellarsdk_helper__["a" /* default */].receivePayment(dto, function(err, result) {
			...
			Object(__WEBPACK_IMPORTED_MODULE_9__ui_payment_awaiting__["b" /* showPaymentAwaitingProgress */])(result)
			.then(function() {
				if (options.redirectUrl) {
					...
					Object(__WEBPACK_IMPORTED_MODULE_8__ui_payment_complete__["a" /* showPaymentComplete */])();
				}
			});
		});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_coinmarketcap_client__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__assets_fonts__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_dom__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__elems__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__template__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__events__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__buttons__ = __webpack_require__(8);
...
function create(options) {
	...
	var targetElem = __WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].targetElem.elem;
	if (!targetElem) {
		return;
	}

	targetElem.classList.add(__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].targetElem.cssClass);
	
	targetElem.appendChild(Object(__WEBPACK_IMPORTED_MODULE_4__utils_dom__["a" /* createElementFromHTML */])('div', Object(__WEBPACK_IMPORTED_MODULE_6__template__["a" /* mainTemplate */])()));

	var root = targetElem.querySelector(__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].root.selector);
	var header = targetElem.querySelector(__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].header.selector);
	var formPanel = targetElem.querySelector(__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].formPanel.selector);
	var total = targetElem.querySelector(__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].total.selector);
	var amount = targetElem.querySelector(__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].amount.selector);
	var publicKey = targetElem.querySelector(__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].publicKey.selector);
	var submitButton = targetElem.querySelector(__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].submitButton.selector);
	
	__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].root.elem = root;
	__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].header.elem = header;
	__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].formPanel.elem = formPanel;;
	__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].total.elem = total;
	__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].amount.elem = amount;
	__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].publicKey.elem = publicKey;
	__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].submitButton.elem = submitButton;

	__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].CMCCLIENT = new __WEBPACK_IMPORTED_MODULE_2__services_coinmarketcap_client__["a" /* CoinMarketCapClient */](__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].amount.elem, options); // todo: refactor this and the one in ./ui/events

	/* ---- */

	__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].total.elem.addEventListener('blur', __WEBPACK_IMPORTED_MODULE_7__events__["c" /* onValidateTotal */]);
	__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].total.elem.addEventListener('input', __WEBPACK_IMPORTED_MODULE_7__events__["c" /* onValidateTotal */]);

	__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].amount.elem.addEventListener('blur', __WEBPACK_IMPORTED_MODULE_7__events__["a" /* onValidateAmount */]);
	__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].amount.elem.addEventListener('input', __WEBPACK_IMPORTED_MODULE_7__events__["a" /* onValidateAmount */]);

	__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].publicKey.elem.addEventListener('blur', __WEBPACK_IMPORTED_MODULE_7__events__["b" /* onValidatePublicKey */]);
	__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].publicKey.elem.addEventListener('input', __WEBPACK_IMPORTED_MODULE_7__events__["b" /* onValidatePublicKey */]);
	...
	__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DTO.payment.from = __WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].publicKey.elem.value;
	...
	if (dtoTotal && dtoTotal.length > 0) {
		__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].total.elem.setAttribute('value', dtoTotal);
		__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].total.elem.setAttribute('disabled', 'disabled');
		var currencyLabel = __WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].total.elem.parentNode.querySelector('.currency').innerHTML = __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DTO.invoice.currency;
		hasValidTotal = true;
		__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].total.elem.dispatchEvent(new Event('input'));
	}
...
function createSubmitHandler(callBack) {
	var btn = __WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].submitButton.elem;
	if (btn) {
		btn.addEventListener('click', function(e) {
			e.preventDefault();
			Object(__WEBPACK_IMPORTED_MODULE_8__buttons__["a" /* setButtonState */])(this, __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].SUBMIT_BUTTON_STATE.IN_PROGRESS)
			callBack.call(this);
		});
		__WEBPACK_IMPORTED_MODULE_5__elems__["a" /* default */].submitButton.elem = btn;
	};
};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__url__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__fortawesome_fontawesome_free_solid_faSpinner__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_coinmarketcap_client__ = __webpack_require__(13);
...
function onValidatePublicKey(e) {
	...
	Object(__WEBPACK_IMPORTED_MODULE_2__validate__["a" /* toggleValidationFeedback */])(e.target, Object(__WEBPACK_IMPORTED_MODULE_2__validate__["c" /* validatePublicKey */])(e.target.value));
};

function onValidateTotal(e) {
	__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DTO.invoice.total = e.target.value;
	Object(__WEBPACK_IMPORTED_MODULE_2__validate__["a" /* toggleValidationFeedback */])(e.target, Object(__WEBPACK_IMPORTED_MODULE_2__validate__["d" /* validateTotal */])());
	__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].CMCCLIENT.fetch();
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ui_template__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ui_elems__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__loader__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__stellarsdk_helper__ = __webpack_require__(11);
...
function validateConfig(options) {
	return __WEBPACK_IMPORTED_MODULE_2__loader__["a" /* default */].js(__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].STELLAR_SDK_URL) //sdkHelper.loadSdk()
