...
var ECCode = __webpack_require__(11)
var ECLevel = __webpack_require__(7)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_config_checker__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__constants__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_error__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_stellarsdk_helper__ = __webpack_require__(9);
...
function init(selector, options) {
	...
	__WEBPACK_IMPORTED_MODULE_4__ui__["a" /* default */].createSubmitHandler(function(e) {
		...
		var isValid = __WEBPACK_IMPORTED_MODULE_4__ui__["a" /* default */].validateTransactionDto(dto);
		if (!isValid.result) {
			__WEBPACK_IMPORTED_MODULE_4__ui__["a" /* default */].setButtonState(__WEBPACK_IMPORTED_MODULE_4__ui__["a" /* default */].elems.submitButton.elem, __WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].SUBMIT_BUTTON_STATE.DISABLED);
			return;
		}
		...
		if (!__WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].MODE.secure) {
			...
			.then(function(result) {
				...
				__WEBPACK_IMPORTED_MODULE_4__ui__["a" /* default */].setButtonState(__WEBPACK_IMPORTED_MODULE_4__ui__["a" /* default */].elems.submitButton.elem, __WEBPACK_IMPORTED_MODULE_1__constants__["a" /* default */].SUBMIT_BUTTON_STATE.PAYMENT_COMPLETE);
				...
				if (options.onSubmit && typeof options.onSubmit === 'function') {
					...
					__WEBPACK_IMPORTED_MODULE_4__ui__["a" /* default */].showSuccess();
				}
			})
			.catch(function(error) {
				// Send the error back to the onSubmit call back (error-first)
				__WEBPACK_IMPORTED_MODULE_4__ui__["a" /* default */].showError(error);
				console.log(error);
			...
			__WEBPACK_IMPORTED_MODULE_4__ui__["a" /* default */].createProgressHtml(dto);
			...
			__WEBPACK_IMPORTED_MODULE_3__utils_stellarsdk_helper__["a" /* default */].receivePayment(dto, function(err, result) {
				...
				__WEBPACK_IMPORTED_MODULE_4__ui__["a" /* default */].updateProgressHtml(result)
				.then(function() {
					Object(__WEBPACK_IMPORTED_MODULE_5__utils_url__["b" /* useRedirectUrl */])(options, result);
					if (options.onSubmit && typeof options.onSubmit === 'function') {
						options.onSubmit.call(this, null, result);
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	ui: {
		render: function(selector, opts) {
			...
			Object(__WEBPACK_IMPORTED_MODULE_0__utils_config_checker__["a" /* validateConfig */])(this.options)
			.catch(function(error) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stellarsdk_helper__ = __webpack_require__(9);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assets_css_style_css__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_coinmarketcap_client__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_error__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__assets_i_FriendBot_favicon_svg__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__assets_fonts__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_qrcode__ = __webpack_require__(33);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__templates_template__ = __webpack_require__(55);
	...
	for (var i = 0, len = toggleKeys.length; i < len; i++) {
		toggleKeys[i].addEventListener('click', function(e) {
			...
			if (__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].MODE.secure) {
				elems.privateSeed.elem.parentNode.parentNode.classList.remove(__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].CLASS.hidden);
				elems.publicKey.elem.parentNode.parentNode.classList.add(__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].CLASS.hidden);
				__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].MODE.secure = false;
			} else {
				elems.privateSeed.elem.parentNode.parentNode.classList.add(__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].CLASS.hidden);
				elems.publicKey.elem.parentNode.parentNode.classList.remove(__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].CLASS.hidden);
...
function showProgressHtml() {
	elems.formPanel.elem.classList.add(__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].CLASS.hidden);
	elems.progressPanel.elem.classList.remove(__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].CLASS.hidden);
};
...
function validateAmount() {
	...
	if (isNaN(amt)) {
		result.errors.push(new __WEBPACK_IMPORTED_MODULE_3__utils_error__["a" /* Err */]('amount is not a number', elems.amount));
		result.result = false;
	}
	if (amt <= 0) {
		result.errors.push(new __WEBPACK_IMPORTED_MODULE_3__utils_error__["a" /* Err */]('amount must be greater than zero', elems.amount));
		result.result = false;
	}
	return result;
};
...
function validatePrivateSeed() {
	...
	if (!key || !window.StellarSdk.StrKey.isValidEd25519SecretSeed(key)) {
		result.errors.push(new __WEBPACK_IMPORTED_MODULE_3__utils_error__["a" /* Err */]('private seed is invalid', elems.privateSeed));
		result.result = false;
	}
	return result;
};
...
function validateTotal() {
	...
	if (isNaN(total)) {
		result.errors.push(new __WEBPACK_IMPORTED_MODULE_3__utils_error__["a" /* Err */]('total is not a number', elems.total));
		result.result = false;
	}
	if (total <= 0) {
		result.errors.push(new __WEBPACK_IMPORTED_MODULE_3__utils_error__["a" /* Err */]('total must be greater than zero', elems.total));
		result.result = false;
	}
	return result;
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_formatter__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_http__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_string__ = __webpack_require__(27);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fortawesome_fontawesome__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__fortawesome_fontawesome_free_solid_faSpinner__ = __webpack_require__(32);
...
var canPromise = __webpack_require__(34)
var QRCode = __webpack_require__(37)
var CanvasRenderer = __webpack_require__(53)
var SvgRenderer = __webpack_require__(54)
...
var Utils = __webpack_require__(0)
var ECLevel = __webpack_require__(7)
var BitBuffer = __webpack_require__(38)
var BitMatrix = __webpack_require__(39)
var AlignmentPattern = __webpack_require__(40)
var FinderPattern = __webpack_require__(41)
var MaskPattern = __webpack_require__(42)
var ECCode = __webpack_require__(11)
var ReedSolomonEncoder = __webpack_require__(43)
var Version = __webpack_require__(12)
var FormatInfo = __webpack_require__(46)
var Mode = __webpack_require__(1)
var Segments = __webpack_require__(47)
var isArray = __webpack_require__(6)
...
var Buffer = __webpack_require__(3)
var Polynomial = __webpack_require__(44)
...
var Mode = __webpack_require__(1)
var NumericData = __webpack_require__(48)
var AlphanumericData = __webpack_require__(49)
var ByteData = __webpack_require__(50)
var KanjiData = __webpack_require__(51)
var Regex = __webpack_require__(13)
var Utils = __webpack_require__(0)
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__error_mustache_html__ = __webpack_require__(56);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__main_template_html__ = __webpack_require__(60);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__progress_mustache_html__ = __webpack_require__(61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__success_mustache_html__ = __webpack_require__(63);
