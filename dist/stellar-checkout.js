...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	ui: {
		render: function(selector, opts) {
			...
			_isStellarSdkLoaded = __WEBPACK_IMPORTED_MODULE_1__stellarsdk_helper__["a" /* default */].loadSdk(function() {

				var dto = __WEBPACK_IMPORTED_MODULE_1__stellarsdk_helper__["a" /* default */].createDto(self.options);
				...
				_isValidDestinationKey = __WEBPACK_IMPORTED_MODULE_2__ui__["a" /* default */].validatePublicKey(self.options.destinationKey);
				...
				self.options.elem = __WEBPACK_IMPORTED_MODULE_2__ui__["a" /* default */].create(self.selector, self.options);

				__WEBPACK_IMPORTED_MODULE_2__ui__["a" /* default */].createSubmitHandler(function(e) {

					// Final sanity check for valid form
					var isValid = __WEBPACK_IMPORTED_MODULE_2__ui__["a" /* default */].validateTransactionDto(dto);
					if (!isValid.result) {
						__WEBPACK_IMPORTED_MODULE_2__ui__["a" /* default */].setButtonState(__WEBPACK_IMPORTED_MODULE_2__ui__["a" /* default */].elems.submitButton.elem, __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].SUBMIT_BUTTON_STATE.DISABLED);
						return;
					}
					...
					if (!__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].MODE.secure) {
						...
						var result = __WEBPACK_IMPORTED_MODULE_1__stellarsdk_helper__["a" /* default */]
						.sendPayment(dto)
						.then(function(result) {

							console.log(result);
							// Show success feedback
							__WEBPACK_IMPORTED_MODULE_2__ui__["a" /* default */].setButtonState(__WEBPACK_IMPORTED_MODULE_2__ui__["a" /* default */].elems.submitButton.elem, __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].SUBMIT_BUTTON_STATE.PAYMENT_COMPLETE);
						...
						.catch(function(error) {
							...
							__WEBPACK_IMPORTED_MODULE_2__ui__["a" /* default */].showError(error);
							console.log(error);
						...
						__WEBPACK_IMPORTED_MODULE_2__ui__["a" /* default */].createProgressHtml(dto);
						// Watch for transactions sent to the destinationKey
						__WEBPACK_IMPORTED_MODULE_1__stellarsdk_helper__["a" /* default */].receivePayment(dto, function(err, result) {
							if (err) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_error__ = __webpack_require__(8);
...
function loadSdk(callback) {
	if (window && window.StellarSdk) {
		console.log(Object(__WEBPACK_IMPORTED_MODULE_1__utils_error__["a" /* Err */])('StellarSdk already loaded', __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].MESSAGE_TYPE.INFO));
		callback.call();
		return false;
	}
