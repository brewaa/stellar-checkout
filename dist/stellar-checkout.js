...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = _err;
/* harmony export (immutable) */ __webpack_exports__["b"] = httpRequest;
/* unused harmony export redirect */
/* harmony export (immutable) */ __webpack_exports__["c"] = redirectIfRedirectUrlConfigured;
...
function _err(msg, msgType) {
	msgType = msgType || __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].MESSAGE_TYPE.ERROR;
	var messageType = msgType ? ' ' + msgType : '';
	return __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].APP_NAME + messageType + ' ' + msg;
}
...
function redirectIfRedirectUrlConfigured(options, result) {
...
var ECLevel = __webpack_require__(8)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__stellarsdk_helper__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ui__ = __webpack_require__(16);
	...
	ui: {
		render: function(selector, opts) {
			...
			_isStellarSdkLoaded = __WEBPACK_IMPORTED_MODULE_2__stellarsdk_helper__["a" /* default */].loadStellarSdk(function() {
				...
				var dto = __WEBPACK_IMPORTED_MODULE_2__stellarsdk_helper__["a" /* default */].createTransactionDto(self.options);

				if (self.options.currency && typeof self.options.currency === 'string' && self.options.currency !== '') {
					_isCurrencySupported = __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].CURRENCIES.indexOf(self.options.currency) !== -1;
					if (!_isCurrencySupported) {
						__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].CONFIG.error = true;
						__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].CONFIG.message = 'Currency not supported. Allowed currencies: ' + __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].CURRENCIES.join(', ');
					}	
				} else {
					self.options.currency = 'USD';
				}

				_isValidDestinationKey = __WEBPACK_IMPORTED_MODULE_3__ui__["a" /* default */].validatePublicKey(self.options.destinationKey);
				if (!_isValidDestinationKey.result) {
					__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].CONFIG.error = true;
					__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].CONFIG.message = 'destinationKey is invalid';
				}

				self.options.elem = __WEBPACK_IMPORTED_MODULE_3__ui__["a" /* default */].create(self.selector, self.options);

				__WEBPACK_IMPORTED_MODULE_3__ui__["a" /* default */].createSubmitHandler(function(e) {

					// Final sanity check for valid form
					var isValid = __WEBPACK_IMPORTED_MODULE_3__ui__["a" /* default */].validateTransactionDto(dto);
					if (!isValid.result) {
						__WEBPACK_IMPORTED_MODULE_3__ui__["a" /* default */].setButtonState(__WEBPACK_IMPORTED_MODULE_3__ui__["a" /* default */].elems.submitButton.elem, __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].SUBMIT_BUTTON_STATE.DISABLED);
						return;
					}
					...
					if (!__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].MODE.secure) {
						...
						var result = __WEBPACK_IMPORTED_MODULE_2__stellarsdk_helper__["a" /* default */]
						.submitTransaction(dto)
						.then(function(result) {

							console.log(result);
							// Show success feedback
							__WEBPACK_IMPORTED_MODULE_3__ui__["a" /* default */].setButtonState(__WEBPACK_IMPORTED_MODULE_3__ui__["a" /* default */].elems.submitButton.elem, __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].SUBMIT_BUTTON_STATE.PAYMENT_COMPLETE);

							// Send to success page if the simple redirect feature is configured
							__WEBPACK_IMPORTED_MODULE_4__utils__["c" /* redirectIfRedirectUrlConfigured */](self.options, result);
							...
							if (self.options.onSubmit && typeof self.options.onSubmit === 'function') {
								...
								__WEBPACK_IMPORTED_MODULE_3__ui__["a" /* default */].showSuccess();
							}
						})
						.catch(function(error) {
							// Send the error back to the onSubmit call back (error-first)
							__WEBPACK_IMPORTED_MODULE_3__ui__["a" /* default */].showError(error);
							console.log(error);
						...
						__WEBPACK_IMPORTED_MODULE_2__stellarsdk_helper__["a" /* default */].receiveTransaction(dto, function(err, result) {
							if (err) {
								self.options.onSubmit.call(this, err);
								return;	
							}
							__WEBPACK_IMPORTED_MODULE_3__ui__["a" /* default */].updateProgressHtml(result);
							__WEBPACK_IMPORTED_MODULE_4__utils__["c" /* redirectIfRedirectUrlConfigured */](self.options, result);
							if (self.options.onSubmit && typeof self.options.onSubmit === 'function') {
								self.options.onSubmit.call(this, null, result);
							}
...
function loadStellarSdk(callback) {
	if (window && window.StellarSdk) {
		console.log(__WEBPACK_IMPORTED_MODULE_1__utils__["a" /* _err */]('StellarSdk already loaded', __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].MESSAGE_TYPE.INFO));
		callback.call();
		return false;
	}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__formatter__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__assets_i_FriendBot_favicon_svg__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__assets_i_FriendBot_favicon_svg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__assets_i_FriendBot_favicon_svg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__fortawesome_fontawesome__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__fortawesome_fontawesome_free_solid_faSpinner__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__fortawesome_fontawesome_free_solid_faSpinner___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__fortawesome_fontawesome_free_solid_faSpinner__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__assets_template_html__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__assets_template_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__assets_template_html__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__assets_templates_progress_mustache_html__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__assets_templates_progress_mustache_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__assets_templates_progress_mustache_html__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__assets_templates_error_mustache_html__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__assets_templates_error_mustache_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__assets_templates_error_mustache_html__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__assets_templates_success_mustache_html__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__assets_templates_success_mustache_html___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__assets_templates_success_mustache_html__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_qrcode__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_qrcode___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_qrcode__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__utils__ = __webpack_require__(4);
...
__WEBPACK_IMPORTED_MODULE_4__fortawesome_fontawesome__["a" /* default */].library.add(__WEBPACK_IMPORTED_MODULE_5__fortawesome_fontawesome_free_solid_faSpinner___default.a);
...
CoinMarketCapClient.prototype.fetch = function() {
	var self = this;
	self.showProgress();
	return __WEBPACK_IMPORTED_MODULE_11__utils__["b" /* httpRequest */]('GET', self.url, { convert: self.options.currency }, '', true)
	.then(function(response) {
		...
		if (data.length > 0) {
			...
			if (lumenPrice) {
				...
				var formattedPrice = __WEBPACK_IMPORTED_MODULE_11__utils__["d" /* replace */](__WEBPACK_IMPORTED_MODULE_2__formatter__["a" /* default */].format(__WEBPACK_IMPORTED_MODULE_2__formatter__["a" /* default */].FORMATS.DECIMAL7, self.priceInLumens), ',', '');
...
function create(selector, options) {
	...
	if (!targetElem) {
		console.log(__WEBPACK_IMPORTED_MODULE_11__utils__["a" /* _err */]('selector not found', __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].MESSAGE_TYPE.ERROR));
	}	

	if (__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].CONFIG.error) {
		var divConfigError = document.createElement('div');
		divConfigError.innerHTML = __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].APP_NAME + ':error:' + __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].CONFIG.message;
	...
	targetElem.appendChild(createElementFromHTML(__WEBPACK_IMPORTED_MODULE_6__assets_template_html___default.a));
...
function createProgressHtml(dto) {
	var compiledHtml = __WEBPACK_IMPORTED_MODULE_7__assets_templates_progress_mustache_html___default()(dto)
	...
	__WEBPACK_IMPORTED_MODULE_10_qrcode___default.a.toCanvas(qrCodeCanvas, dto.destinationKey, function (error) {
		if (error) {
			console.error(error);
		}
	});
...
function createSubmitHandler(callBack) {
	...
	if (btn) {
		btn.addEventListener('click', function(e) {
			e.preventDefault();
			setButtonState(this, __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].SUBMIT_BUTTON_STATE.IN_PROGRESS)
			callBack.call(this);
		});
...
function showError(error) {
	error.friendBotSvg = __WEBPACK_IMPORTED_MODULE_3__assets_i_FriendBot_favicon_svg___default.a;
	var compiledHtml = __WEBPACK_IMPORTED_MODULE_8__assets_templates_error_mustache_html___default()(error);
	elems.root.elem.appendChild(createElementFromHTML(compiledHtml));
...
function showSuccess(obj) {
	var compiledHtml = __WEBPACK_IMPORTED_MODULE_9__assets_templates_success_mustache_html___default()(obj);
	elems.root.elem.appendChild(createElementFromHTML(compiledHtml));
};
...
function toggleValidationFeedback(target, test) {
	...
	var formIsValid = validateTransactionDto(__WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].DTO);
	if (formIsValid.result) {
		setButtonState(elems.submitButton.elem, __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].SUBMIT_BUTTON_STATE.NORMAL);
	} else {
		setButtonState(elems.submitButton.elem, __WEBPACK_IMPORTED_MODULE_0__constants__["a" /* default */].SUBMIT_BUTTON_STATE.DISABLED);
	}
};
...
var canPromise = __webpack_require__(37)
var QRCode = __webpack_require__(40)
var CanvasRenderer = __webpack_require__(56)
var SvgRenderer = __webpack_require__(57)
...
var Utils = __webpack_require__(0)
var ECLevel = __webpack_require__(8)
var BitBuffer = __webpack_require__(41)
var BitMatrix = __webpack_require__(42)
var AlignmentPattern = __webpack_require__(43)
var FinderPattern = __webpack_require__(44)
var MaskPattern = __webpack_require__(45)
var ECCode = __webpack_require__(10)
var ReedSolomonEncoder = __webpack_require__(46)
var Version = __webpack_require__(11)
var FormatInfo = __webpack_require__(49)
var Mode = __webpack_require__(1)
var Segments = __webpack_require__(50)
var isArray = __webpack_require__(7)
...
var Buffer = __webpack_require__(2)
var Polynomial = __webpack_require__(47)
...
var Mode = __webpack_require__(1)
var NumericData = __webpack_require__(51)
var AlphanumericData = __webpack_require__(52)
var ByteData = __webpack_require__(53)
var KanjiData = __webpack_require__(54)
var Regex = __webpack_require__(12)
var Utils = __webpack_require__(0)
var dijkstra = __webpack_require__(55)
